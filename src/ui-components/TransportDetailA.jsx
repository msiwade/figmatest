...
export default function TransportDetailA(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        stayEndTimeSlot: { width: "unset", alignSelf: "stretch" },
        "Frame 468": {
          direction: "column",
        ...
        stayTimeAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 441414143": { shrink: "1", grow: "1", basis: "0" },
        ...
        TransportDetailA: { width: "392px", padding: "5px 0px 5px 0px" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "TransportDetailA")}
      {...rest}
    >
      <Flex
        gap="5px"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 4413854085")}
              >
                <TextField
                  width="750px"
                  height="unset"
            ...
            >
              <Text
                ...
                whiteSpace="pre-wrap"
                children="滞在時間"
                {...getOverrideProps(overrides, "\u6EDE\u5728\u6642\u9593")}
              ></Text>
              <Flex
                gap="2px"
                direction="column"
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 441414143")}
              >
                <Flex
                  gap="10px"
                  direction="row"
                ...
                >
                  <Flex
                    ...
                    padding="0px 0px 0px 0px"
                    display="flex"
                    {...getOverrideProps(overrides, "stayStartTimeSlot")}
                  >
                    <TextField
                      width="200px"
                      height="unset"
                      ...
                      labelHidden={false}
                      variation="default"
                      {...getOverrideProps(overrides, "stayStartTime")}
                    ></TextField>
                  </Flex>
                  <Text
                    fontFamily="Noto Sans JP"
                  ...
                  <Flex
                    ...
                    padding="0px 0px 0px 0px"
                    display="flex"
                    {...getOverrideProps(overrides, "stayEndTimeSlot")}
                  >
                    <TextField
                      width="200px"
                      height="unset"
                      ...
                      labelHidden={false}
                      variation="default"
                      {...getOverrideProps(overrides, "stayEndTime")}
                    ></TextField>
                  </Flex>
                </Flex>
                <CustomAlert
                  ...
                  padding="0px 0px 0px 0px"
                  isshow={true}
                  {...getOverrideProps(overrides, "stayTimeAlert")}
                ></CustomAlert>
              </Flex>
            </Flex>
            <Flex
      ...
      >
        ...
        >
          <Icon
            ...
            left="12.5%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector4242562")}
          ></Icon>
        </View>
        <View
          width="22px"
        ...
        >
          <Icon
            ...
            left="10.42%"
            right="10.42%"
            {...getOverrideProps(overrides, "Vector2984393")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="8.33%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector6092109")}
          ></Icon>
        </View>
      </Flex>
    </Flex>

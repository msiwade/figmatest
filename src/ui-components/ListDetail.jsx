...
export default function ListDetail(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "ListDetail")}
      {...rest}
    >
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          whiteSpace="pre-wrap"
          children="entryDate"
          {...getOverrideProps(overrides, "entryDate")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "specification")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          whiteSpace="pre-wrap"
          children="packaging"
          {...getOverrideProps(overrides, "packaging")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          whiteSpace="pre-wrap"
          children="workRoute"
          {...getOverrideProps(overrides, "workRoute")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          whiteSpace="pre-wrap"
          children="shipDate"
          {...getOverrideProps(overrides, "shipDate")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="desiredDate"
          {...getOverrideProps(overrides, "desiredDate")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"
      ...
      >
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="compleationDate"
          {...getOverrideProps(overrides, "compleationDate")}
        ></Text>
      </Flex>
      <Flex
        gap="10px"

...
export default function PaymentDocumentReview(props) {
  ...
  const variants = [
    ...
    },
    {
      overrides: {
        ...
        "\u627F\u8A8D\u72B6\u6CC1\uFF1A": {},
        status: {},
        "Frame 4321712928": { right: "72px" },
        close: {},
        titleDocumentReview: { top: "calc(50% - 14.5px - 1.5px)", left: "8px" },
        ...
        "Frame 437": { padding: "10px 0px 10px 10px" },
        "\u6DFB\u4ED8\u8CC7\u6599": { width: "100px" },
        ...
        PaymentDocumentReview: { width: "390px" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "PaymentDocumentReview")}
      {...rest}
    >
      <View
        width="unset"
      ...
      >
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 4321712928")}
        >
          <Text
            fontFamily="Noto Sans JP"
            fontSize="16px"
      ...
      <Flex
        ...
        display="flex"
        {...getOverrideProps(overrides, "Frame 4321712933")}
      >
        <Text
          fontFamily="Noto Sans JP"
          fontSize="13px"

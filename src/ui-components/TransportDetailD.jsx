...
export default function TransportDetailD(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        "Frame 4415222439": {},
        paymentDestinationFrame: { alignSelf: "stretch" },
        "\u5185\u5BB9": { width: "60px" },
        ...
        "Frame 446": {},
        "Frame 471": {},
        "Frame 478": { width: "unset", shrink: "1", grow: "1", basis: "0" },
        Vector4242574: {},
        add: {},
        Vector2984405: {},
        copy: {},
        ...
        TransportDetailD: { width: "392px", padding: "5px 0px 5px 0px" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "TransportDetailD")}
      {...rest}
    >
      <Flex
        gap="5px"
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="0%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector5943888")}
                  ></Icon>
                </View>
              </Flex>
              <Flex
            ...
            <Flex
              ...
              padding="2px 10px 2px 10px"
              display="flex"
              {...getOverrideProps(overrides, "paymentDestinationFrame")}
            >
              <Text
                fontFamily="Noto Sans JP"
                fontSize="13px"
              ...
              <Flex
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 4415222439")}
              >
                <TextField
                  width="750px"
                  height="unset"
            ...
            >
              ...
              <Flex
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 441414773")}
              >
                <TextField
                  width="750px"
                  height="unset"
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="4.17%"
                    right="4.17%"
                    {...getOverrideProps(overrides, "Vector1744957")}
                  ></Icon>
                </View>
              </Flex>
              <View
      ...
      >
        ...
        >
          <Icon
            ...
            left="12.5%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector4242574")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="10.42%"
            right="10.42%"
            {...getOverrideProps(overrides, "Vector2984405")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="8.33%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector6092121")}
          ></Icon>
        </View>
      </Flex>
    </Flex>

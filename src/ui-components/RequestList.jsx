...
export default function RequestList(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "RequestList")}
      {...rest}
    >
      <Flex
        gap="0"
      ...
      >
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="記入日"
            {...getOverrideProps(overrides, "\u8A18\u5165\u65E5")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="製品名"
            {...getOverrideProps(overrides, "\u88FD\u54C1\u540D")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="作業ルート"
            {...getOverrideProps(overrides, "\u4F5C\u696D\u30EB\u30FC\u30C8")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="出荷予定日"
            {...getOverrideProps(overrides, "\u51FA\u8377\u4E88\u5B9A\u65E5")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"

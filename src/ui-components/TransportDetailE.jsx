...
export default function TransportDetailE(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        Km: {},
        "Frame 442414890": { alignSelf: "stretch" },
        mileageAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 441414889": {},
        "Frame 454": { overflow: "hidden", alignSelf: "stretch" },
        "\u91D1\u984D": { width: "60px" },
        "\u8A73\u7D30": {
          fontSize: "12px",
          lineHeight: "18px",
        ...
        "Frame 452": { overflow: "hidden", alignSelf: "stretch" },
        "\u7406\u7531": { width: "60px" },
        businessTripReason: {
          width: "unset",
          placeholder: "\u4EFB\u610F\u3000\u4F8B\uFF091on1\u306E\u305F\u3081",
          alignSelf: "stretch",
        },
        "Frame 4417382381": {},
        ...
        TransportDetailE: { width: "392px", padding: "5px 0px 5px 0px" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "TransportDetailE")}
      {...rest}
    >
      <Flex
        gap="5px"
          ...
          >
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="0%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector5943896")}
                  ></Icon>
                </View>
              </Flex>
              <Flex
                ...
                display="flex"
                {...getOverrideProps(overrides, "Frame 442414878")}
              >
                <Flex
                  gap="10px"
                  direction="row"
            ...
            >
              ...
              <Flex
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 441414884")}
              >
                <TextField
                  width="750px"
                  height="unset"
                  placeholder="必須　例）トラスト本社～長岡駅"
                  shrink="0"
                  size="small"
                  isDisabled={false}
                  labelHidden={false}
            ...
            >
              <Text
                ...
                whiteSpace="pre-wrap"
                children="走行距離"
                {...getOverrideProps(overrides, "\u8D70\u884C\u8DDD\u96E2")}
              ></Text>
              <Flex
                gap="2px"
                direction="column"
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 441414889")}
              >
                <Flex
                  gap="10px"
                  direction="row"
                  ...
                  padding="2px 0px 2px 0px"
                  display="flex"
                  {...getOverrideProps(overrides, "Frame 442414890")}
                >
                  <Text
                    fontFamily="Noto Sans JP"
                    fontSize="14px"
                    ...
                    whiteSpace="pre-wrap"
                    children="片道"
                    {...getOverrideProps(overrides, "\u7247\u9053")}
                  ></Text>
                  <TextField
                    width="300px"
                    height="unset"
                    placeholder="必須　例）17.2"
                    shrink="0"
                    size="small"
                    isDisabled={false}
                    labelHidden={false}
                ...
                <CustomAlert
                  ...
                  padding="0px 0px 0px 0px"
                  isshow={true}
                  {...getOverrideProps(overrides, "mileageAlert")}
                ></CustomAlert>
              </Flex>
            </Flex>
            <Flex
            ...
            >
              ...
              >
                <Text
                  ...
                  padding="0px 0px 0px 0px"
                  whiteSpace="pre-wrap"
                  children="走行距離×15円（往復の場合は×2）※小数点以下四捨五入"
            ...
            >
              ...
              <Flex
                ...
                padding="2px 0px 2px 0px"
                display="flex"
                {...getOverrideProps(overrides, "Frame 4417382381")}
              >
                <TextField
                  width="750px"
                  height="unset"
                  placeholder="任意　例）1on1のため本社出社"
                  shrink="0"
                  size="small"
                  isDisabled={false}
                  labelHidden={false}
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="4.17%"
                    right="4.17%"
                    {...getOverrideProps(overrides, "Vector1744969")}
                  ></Icon>
                </View>
              </Flex>
              <View
      ...
      >
        ...
        >
          <Icon
            ...
            left="12.5%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector4242578")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="10.42%"
            right="10.42%"
            {...getOverrideProps(overrides, "Vector2984409")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="8.33%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector6092125")}
          ></Icon>
        </View>
      </Flex>
    </Flex>

...
export default function AddAttachmentForm(props) {
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "AddAttachmentForm")}
      {...rest}
    >
      <View
        width="1110px"
      ...
      >
        ...
        >
          <Icon
            ...
            left="20.83%"
            right="20.83%"
            {...getOverrideProps(overrides, "Vector6812712")}
          ></Icon>
        </View>
        <Text
      ...
      >
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 4926812722")}
        >
          <Flex
            gap="10px"
            direction="column"
      ...
      >
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 4936812728")}
        >
          <TextField
            width="640px"
            height="unset"
      ...
      <Flex
        ...
        backgroundColor="rgba(255,255,255,1)"
        display="flex"
        {...getOverrideProps(overrides, "Frame 4926812731")}
      >
        <Text
          fontFamily="Noto Sans JP"
          fontSize="13px"
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 4936812733")}
        >
          <Flex
            gap="5px"
            direction="row"
            ...
            padding="0px 0px 0px 0px"
            display="flex"
            {...getOverrideProps(overrides, "Frame 4946812734")}
          >
            <TextField
              width="300px"
              height="unset"
      ...
      <Flex
        ...
        backgroundColor="rgba(255,255,255,1)"
        display="flex"
        {...getOverrideProps(overrides, "Frame 4936812738")}
      >
        <Text
          fontFamily="Noto Sans JP"
          fontSize="13px"
        ...
        >
          ...
          >
            <Icon
              ...
              left="4.17%"
              right="4.17%"
              {...getOverrideProps(overrides, "Vector6812745")}
            ></Icon>
          </View>
        </Flex>
        <Flex
      ...
      <Flex
        ...
        backgroundColor="rgba(255,255,255,1)"
        display="flex"
        {...getOverrideProps(overrides, "Frame 4946812749")}
      >
        <Button
          width="unset"
          height="unset"

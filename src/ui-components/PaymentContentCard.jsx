...
export default function PaymentContentCard(props) {
  ...
  const variants = [
    ...
    {
      overrides: {
        "\u8CFC\u5165\u65E5": { width: "40px", height: "unset" },
        paymentDate: { shrink: "1", grow: "1", basis: "0" },
        paymentDateSlot: { shrink: "1", grow: "1", basis: "0" },
        paymentDateAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 4411132889": {},
        "Frame 448": {
          width: "unset",
        ...
        "\u652F\u6255\u5148": { width: "40px", height: "unset" },
        paymentDestination: { width: "unset", alignSelf: "stretch" },
        paymentDestinationAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 4411532904": { shrink: "1", grow: "1", basis: "0" },
        "Frame 449": { alignSelf: "stretch" },
        "\u5185\u5BB9": { width: "40px", height: "unset" },
        content: { width: "unset", alignSelf: "stretch" },
        contentAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 455": { shrink: "1", grow: "1", basis: "0" },
        "Frame 450": { alignSelf: "stretch", opacity: "0.8999999761581421" },
        "\u91D1\u984D": { width: "40px", height: "unset" },
        paymentAmount: { shrink: "1", grow: "1", basis: "0" },
        "\u5186": {},
        "Frame 442": { alignSelf: "stretch" },
        paymentAmountAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 456": { shrink: "1", grow: "1", basis: "0" },
        "Frame 451": { padding: "5px 0px 5px 10px", alignSelf: "stretch" },
        "\u4E8B\u7531": { width: "40px", height: "unset" },
        reason: { width: "unset", alignSelf: "stretch" },
        reasonAlert: { width: "unset", alignSelf: "stretch" },
        "Frame 457": { shrink: "1", grow: "1", basis: "0" },
        ...
        Vector6052077: {
          ...
          paths: [
            {
              d: "M11.6667 0L1.66667 0C0.75 0 0 0.75 0 1.66667L0 13.3333L1.66667 13.3333L1.66667 1.66667L11.6667 1.66667L11.6667 0ZM14.1667 3.33333L5 3.33333C4.08333 3.33333 3.33333 4.08333 3.33333 5L3.33333 16.6667C3.33333 17.5833 4.08333 18.3333 5 18.3333L14.1667 18.3333C15.0833 18.3333 15.8333 17.5833 15.8333 16.6667L15.8333 5C15.8333 4.08333 15.0833 3.33333 14.1667 3.33333ZM14.1667 16.6667L5 16.6667L5 5L14.1667 5L14.1667 16.6667Z",
              fill: "rgba(0,0,0,1)",
              fillRule: "nonzero",
            },
          ],
        ...
        PaymentContentCard: { width: "265px", padding: "4px 0px 4px 0px" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "PaymentContentCard")}
      {...rest}
    >
      <Flex
        gap="0"
      ...
      >
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="購入日"
            {...getOverrideProps(overrides, "\u8CFC\u5165\u65E5")}
          ></Text>
          <Flex
            gap="2px"
            direction="column"
            ...
            display="flex"
            {...getOverrideProps(overrides, "Frame 4411132889")}
          >
            <Flex
              gap="10px"
              direction="row"
              ...
              padding="0px 0px 0px 0px"
              display="flex"
              {...getOverrideProps(overrides, "paymentDateSlot")}
            >
              <TextField
                width="unset"
                height="unset"
            ...
            <CustomAlert
              ...
              padding="0px 0px 0px 0px"
              isshow={true}
              {...getOverrideProps(overrides, "paymentDateAlert")}
            ></CustomAlert>
          </Flex>
        </Flex>
        <Flex
        ...
        >
          ...
          <Flex
            ...
            padding="5px 0px 5px 0px"
            display="flex"
            {...getOverrideProps(overrides, "Frame 4411532904")}
          >
            <TextField
              width="765px"
              height="unset"
        ...
        >
          ...
          >
            ...
            <CustomAlert
              ...
              padding="0px 0px 0px 0px"
              isshow={true}
              {...getOverrideProps(overrides, "paymentAmountAlert")}
            ></CustomAlert>
          </Flex>
        </Flex>
        <Flex
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector6192665")}
              ></Icon>
            </View>
            <View
              width="24px"
            ...
            >
              <Icon
                ...
                left="4.17%"
                right="4.17%"
                {...getOverrideProps(overrides, "Vector6052074")}
              ></Icon>
            </View>
          </Flex>
          <View
      ...
      >
        ...
        >
          <Icon
            ...
            left="12.5%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector6092087")}
          ></Icon>
        </View>
        <View
          width="22px"
        ...
        >
          <Icon
            ...
            viewBox={{
              minX: 0,
              minY: 0,
              width: 17.41666603088379,
              height: 20.166667938232422,
            }}
            paths={[
              {
                d: "M12.8333 0L1.83333 0C0.825 0 0 0.825 0 1.83333L0 14.6667L1.83333 14.6667L1.83333 1.83333L12.8333 1.83333L12.8333 0ZM15.5833 3.66667L5.5 3.66667C4.49167 3.66667 3.66667 4.49167 3.66667 5.5L3.66667 18.3333C3.66667 19.3417 4.49167 20.1667 5.5 20.1667L15.5833 20.1667C16.5917 20.1667 17.4167 19.3417 17.4167 18.3333L17.4167 5.5C17.4167 4.49167 16.5917 3.66667 15.5833 3.66667ZM15.5833 18.3333L5.5 18.3333L5.5 5.5L15.5833 5.5L15.5833 18.3333Z",
                fill: "rgba(0,0,0,1)",
                fillRule: "nonzero",
              },
            ]}
            ...
            left="10.42%"
            right="10.42%"
            {...getOverrideProps(overrides, "Vector6052077")}
          ></Icon>
        </View>
        <View
          width="24px"
        ...
        >
          <Icon
            ...
            left="8.33%"
            right="8.33%"
            {...getOverrideProps(overrides, "Vector6092135")}
          ></Icon>
        </View>
      </Flex>
    </Flex>

...
export declare type RequestNameOverridesProps = {
    RequestName?: PrimitiveOverrideProps<FlexProps>;
...
export declare type RequestNameProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: RequestNameOverridesProps | undefined | null;
}>;
export default function RequestName(props: RequestNameProps): React.ReactElement;
